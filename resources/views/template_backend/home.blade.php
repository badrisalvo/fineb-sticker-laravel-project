                          ...
                          <div class="breadcome-list map-mg-t-40-gl shadow-reset">
                              <div class="row">
                                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                      ...
                                      <li><a href="#">Halaman Awal</a> <span class="bread-slash">/</span>
                                      <span class="bread-blod">@yield('halaman')</span>
                                      </li>
            										</div>
                                  </div>
                                  <!-- <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                      <ul class="breadcome-menu">
                                          ...
                                          <li><a href="{{ route('order.index') }}">Order</a> <span class="bread-slash">/</span>
                                          </li>
