...
@section('halaman', 'Tampilan Pesanan')
@section('content')
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="contact-img-v2">
                                    <img src="{{ asset($order->barang->gambar) }}" alt="" width="300" height="200" />
                                    <h2><a class="contact-client-name">{{ $order->namaBarang($order->barang_id) }}</a></h2>
                                </div><br>
                                <div class="contact-client-address">
                                    <h3>Jumlah: {{ $order->quantity }}</h3>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                @if ($order->bukti($order->id) == true)
                                    <div class="contact-img-v2">
                                        <img src="{{ asset($order->bukti($order->id)->foto) }}" alt="" width="300" height="200" />
                                    </div><hr><br>
                                    <div class="contact-client-address">
