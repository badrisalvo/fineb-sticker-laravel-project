           	...
           	<div class="container box_1620">
                ...
                @endif
                  ...
                  @endif
                    ...
                    @else
										  <li><a href="#"><i class="lnr lnr-calendar-full"></i>Tidak ada data</a></li>
                    @endif
                    @if($user->telepon)
										  <li><a href="#"><i class="lnr lnr-phone-handset"></i>{{ $user->telepon }}</a></li>
                    @else
										  <li><a href="#"><i class="lnr lnr-phone-handset"></i>Tidak ada data</a></li>
                    @endif
                    @if($user->email)
										  <li><a href="#"><i class="lnr lnr-envelope"></i>{{ $user->email }}</a></li>
                    @else
										  <li><a href="#"><i class="lnr lnr-envelope"></i>Tidak ada data</a></li>
                    @endif
                    ...
                    @else
										  <li><a href="#"><i class="lnr lnr-home"></i>Tidak ada data</a></li>
                    @endif
									</ul>
								</div><br><br>
                <a href="/" class="btn btn-primary">Halaman Awal</a>
                @if ($user -> role == "admin")
                <a href="/merek" class="btn btn-primary">Halaman Admin</a>
                @endif
                <a href="{{ route('edit_profil', Auth::user()->id) }}" class="btn btn-success">Ubah Data</a>
                <a href="{{ route('logout') }}" class="btn btn-danger" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">{{ __('Keluar') }}</a>
